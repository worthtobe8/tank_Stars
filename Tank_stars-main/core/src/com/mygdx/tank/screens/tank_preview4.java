...
public class tank_preview4 implements Screen {
    ...
    public tank_preview4(MyGame main_menu){
        this.main_menu= main_menu;
        background=new Texture(Gdx.files.internal("coalition.png"));
        side_menu=new Texture (Gdx.files.internal("p1tank4.png"));
