...
public class tank_preview2 implements Screen {
    ...
    public tank_preview2(MyGame main_menu){
        this.main_menu= main_menu;
        background=new Texture(Gdx.files.internal("frost.png"));
        side_menu=new Texture (Gdx.files.internal("p1tank2.png"));
        right_button=new Texture(Gdx.files.internal("right_arrow.png"));
        left_button=new Texture(Gdx.files.internal("left_arrow.png"));
    ...
    public void render(float delta) {
        ...
        batch.draw(left_button,490,240,30,40);
        ...
        if (Gdx.input.justTouched()) {
            ...
            if (Gdx.input.getX() > 385 * x & Gdx.input.getX() < 415 * x & Gdx.input.getY() > 200 * y & Gdx.input.getY() < 240 * y) {
                main_menu.setScreen(new tank_preview(this.main_menu));
            }
            if(Gdx.input.getX()>605*x & Gdx.input.getX()<635*x & Gdx.input.getY()>200*y & Gdx.input.getY()<240*y){
                    main_menu.setScreen(new tank_preview3(this.main_menu));
            }
