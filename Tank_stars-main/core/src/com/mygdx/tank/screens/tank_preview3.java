...
public class tank_preview3 implements Screen {
    ...
    public tank_preview3(MyGame main_menu){
        this.main_menu= main_menu;
        background=new Texture(Gdx.files.internal("Buratino.png"));
        side_menu=new Texture (Gdx.files.internal("p1tank3.png"));
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.justTouched()) {
            ...
            if(Gdx.input.getX()>605*x & Gdx.input.getX()<635*x & Gdx.input.getY()>200*y & Gdx.input.getY()<240*y){
                main_menu.setScreen(new tank_preview4(this.main_menu));
            }
